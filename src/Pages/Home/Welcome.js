    ...
    return(
        <dev>
            ...
            <div className="hero-content flex-col lg:flex-row-reverse">
                <img src="https://simmifoundation.org/home/images/home/map-dark.png" className="w-full md:max-w-md lg:max-w-md hover:scale-125 transition duration-700 ease-in-out " />
                <div>
